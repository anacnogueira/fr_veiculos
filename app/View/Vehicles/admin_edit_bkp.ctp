...
<?php echo $this->Form->input('type_id',array('label'=>'Tipo*:','type'=>'select'))."\n"; ?>
...
<?php echo $this->Form->input('manufacturing_year',array('label'=>'Ano fabricação:','size'=>'4','maxlength'=>'4','class'=>'custom onlyNumbers')); ?>
<?php echo $this->Form->input('model_year',array('label'=>'Ano modelo:','size'=>'4','maxlength'=>'4','class'=>'custom onlyNumbers')); ?>
<?php echo $this->Form->input('kilometrage',array('label'=>'Kilometragem:','size'=>10,'class'=>'custom onlyNumbers')); ?>
<?php echo $this->Form->input('price',array('label'=>'Valor:','class'=>'custom valor','size'=>10)); ?>
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Excluir', true), array('action' => 'admin_delete', $this->Form->value('Vehicle.id')), null, sprintf('Tem certeza que deseja excluir o registro  # %s?', $this->Form->value('Vehicle.id'))); ?></li>
